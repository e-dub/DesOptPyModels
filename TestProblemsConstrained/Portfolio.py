...
def SysEq(x, gc):
    mu = np.array( (41.700,	20.200,	19.363,	45.675,	17.213,	33.261,	10.450,	19.738,	9.538,	60.400)   )  # average annual return
...
xOpt, fOpt, SP = DesOpt(x0=x0, xL=xL, xU=xU, gc=gc, SysEq=SysEq, Alg=Alg, StatusReport=True, DesVarNorm=True,
                        DoE=False, SBDO=False, ResultReport=False, deltax=1e-2, Debug=False, OptNameAdd="Portfolio")
